...
for city in range(150):
    ...
    rr1 = rr_no2**((no2_1-TMREL_no2)/scale_no2)
    paf1 = (rr1-1)/rr1 
    mb1[city,0] = paf1*I0*popcity
    apaf1[city,0] = paf1
    
    rr2 = rr_no2**((no2_2-TMREL_no2)/scale_no2)
    paf2 = (rr2-1)/rr2 
    ...
    # LOWER
    paf1_LOWER = (rr_no2_LOWER**((no2_1-TMREL_no2)/scale_no2)-1)/rr_no2_LOWER**((no2_1-TMREL_no2)/scale_no2)
    mb1_LOWER[city,0] = paf1_LOWER*I0*popcity
    apaf1_LOWER[city,0] = paf1_LOWER
    
    paf2_LOWER = (rr_no2_LOWER**((no2_2-TMREL_no2)/scale_no2)-1)/rr_no2_LOWER**((no2_2-TMREL_no2)/scale_no2)
    ...
    # UPPER
    paf1_UPPER = (rr_no2_UPPER**((no2_1-TMREL_no2)/scale_no2)-1)/rr_no2_UPPER**((no2_1-TMREL_no2)/scale_no2)
    mb1_UPPER[city,0] = paf1_UPPER*I0*popcity
    apaf1_UPPER[city,0] = paf1_UPPER
    
    paf2_UPPER = (rr_no2_UPPER**((no2_2-TMREL_no2)/scale_no2)-1)/rr_no2_UPPER**((no2_2-TMREL_no2)/scale_no2)
